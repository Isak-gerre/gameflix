            ...
            <nav className={`${Styles.nav}`}>
                  <div className={`${Styles.menucontent}`}>
                        ...
                        <div className={`${Styles.menu}`}>
                              ...
                              <Menubutton text="Most Played" href="/"></Menubutton>
                              <Menubutton text="Newly added" href="/"></Menubutton>
                              <p className={`${Styles.menutitle}`}>Genres</p>
                              <Menubutton text="Action" href="/"></Menubutton>
                              <Menubutton text="Adventure" href="/"></Menubutton>
                              <Menubutton text="RPG" href="/"></Menubutton>
                              <Menubutton text="Shooter" href="/"></Menubutton>
